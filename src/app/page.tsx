...
const translations = {
  "pt-BR": {
    ...
    stats: {
      ...
      description:
        "Uma visão objetiva do alcance construído pelo canal. Os dados são apresentados sem estimativas ou métricas não fornecidas pelo YouTube Studio.",
      main: [
        {
          value: "1,24 MIL",
    ...
    games: {
      ...
      titleLine2: "DESTAQUE.",
      description:
        "Algumas das coberturas que mais se destacaram no KILL LIPE. Acesse diretamente as playlists ou vídeos publicados no canal.",
      playlist: "VER PLAYLIST",
      video: "VER VÍDEO",
      upcomingEyebrow: "Em breve no canal",
      upcomingTitle: "PRÓXIMAS COBERTURAS",
      upcomingDescription:
        "Jogos já confirmados para aparecer no KILL LIPE. Novos títulos serão adicionados conforme as próximas coberturas forem definidas.",
      confirmed: "COBERTURA CONFIRMADA",
      soon: "EM BREVE",
      catalog:
  ...
  en: {
    ...
    stats: {
      ...
      description:
        "A clear view of the reach built by the channel. The figures are presented without estimates or metrics not provided by YouTube Studio.",
      main: [
        {
          value: "1.24K",
    ...
    games: {
      ...
      titleLine2: "GAMES.",
      description:
        "Explore some of KILL LIPE's standout game coverage. Open the playlists or videos directly on the channel.",
      playlist: "VIEW PLAYLIST",
      video: "VIEW VIDEO",
      upcomingEyebrow: "Coming to the channel",
      upcomingTitle: "UPCOMING COVERAGE",
      upcomingDescription:
        "Games already confirmed for coverage on KILL LIPE. More titles will be added as upcoming coverage is confirmed.",
  ...
  es: {
    ...
    stats: {
      ...
      description:
        "Una visión objetiva del alcance construido por el canal. Los datos se presentan sin estimaciones ni métricas no proporcionadas por YouTube Studio.",
      main: [
        {
          value: "1,24 MIL",
    ...
    games: {
      ...
      description:
        "Algunas de las coberturas más destacadas de KILL LIPE. Accede directamente a las playlists o videos publicados en el canal.",
      playlist: "VER PLAYLIST",
      video: "VER VIDEO",
      upcomingEyebrow: "Próximamente en el canal",
      upcomingTitle: "PRÓXIMAS COBERTURAS",
      upcomingDescription:
        "Juegos ya confirmados para aparecer en KILL LIPE. Se añadirán nuevos títulos a medida que se confirmen próximas coberturas.",
      confirmed: "COBERTURA CONFIRMADA",
      soon: "PRÓXIMAMENTE",
      catalog:
...
export default function Home() {
  ...
  useEffect(() => {
    const savedLocale = window.localStorage.getItem("kill-lipe-language");

    if (savedLocale === "pt-BR" || savedLocale === "en" || savedLocale === "es") {
                  ...
                  <article key={game.title}>
                    <div className="group relative aspect-[2/3] overflow-hidden border border-white/10 bg-[#0a0a0a]">
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4">
                        <span className="text-[8px] font-bold uppercase tracking-[0.12em] text-zinc-300 sm:text-[9px] sm:tracking-[0.16em]">
                          {t.games.soon}
                        </span>
                      </div>
                    </div>
        ...
        >
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mt-16">
              ...
              <div className="grid border-x border-t border-white/10 md:grid-cols-5">
                {t.companies.info.map((item) => (
                  <div
                    key={item.label}
                    className="border-b border-white/10 p-6 md:border-r md:last:border-r-0"
                  >
